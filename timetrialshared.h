...
#ifdef FLATOUT_1
	//inputState.keys[REPLAYINPUT_GAS] = pPlayer->fGasPedal;
	//inputState.keys[REPLAYINPUT_BRAKE] = pPlayer->fBrakePedal;
	//inputState.keys[REPLAYINPUT_LEFT] = pPlayer->fOutputSteerAngle;
#elif FLATOUT_UC
	for (int i = 0; i < 20; i++) {
